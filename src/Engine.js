...
// private attributes and methods
    ...
    var compterVoisin = function (ligne , col) {
      var cpt = compterVoisinBas(ligne, col) + compterVoisinHaut(ligne,col)+compterVoisinGauche(ligne,col)+compterVoisindroit(ligne,col);
      return cpt;
    };
...
// public methods
    ...
    this.setPlayerScore = function (pickcolor) {
        var p = players[this.getCurrentPlayer()], c = this.getColor(), color, player = this.getCurrentPlayer();
